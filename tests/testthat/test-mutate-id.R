...
test_that("mutate_id creates appropriate IDs for standard case [NMV-MID-001]", {
...
test_that("mutate_id creates appropriate IDs with unique starting ID [NMV-MID-002]", {
