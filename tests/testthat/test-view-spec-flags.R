...
test_that("view_spec_flags doesn't detect columns that do not exist in spec or data [NMV-VSF-001]", {
...
test_that("view_spec_flags concatenates multiple columns when more than 1 present for a flag[ [NMV-VSF-002]", {
